...
from book_scraper.data_extract.book_data_extract import get_book_data_headers, clean_books_data
...
if __name__ == '__main__':
    ...
    csv_parser.write_data(all_data_scraper_name, get_book_data_headers(), all_data_raw, all_data_clean, all_data_scraper_name)